...
const SingleCourse = () => {
    ...
    if (!courseIdValidator(id)) return redirect("/not-found");
            ...
            <div className="row">
                            ...
                            <form>
                                <div className="row">
                                    ...
                                    <div className="col-md-8 col-sm-12 col-xs-12">
                                        <div className="form-group">
                                            <textarea className="form-control" placeholder="متن نظر"/>
                                        </div>
                                        <div className="row">
                                    ...
                                    <ul className="pagination justify-content-center">
                                        ...
                                        <li className="page-item">
                                            <a className="page-link" href="#" aria-label="Next">
                                                <span aria-hidden="true"><i
                                                    className="zmdi zmdi-chevron-left"/></span>
                                            </a>
                                        </li>
                                    </ul>
                                </nav>
                ...
                <aside className="col-md-4 col-sm-12 col-xs-12 pull-right">
                    ...
                    <div className="share-layer">
                        ...
                        <a href=""><i className="zmdi zmdi-google-old"/></a>
